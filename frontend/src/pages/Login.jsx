    ...
    return (
        <div className="max-w-md w-full mx-auto mt-10">
            ...
            <p className="mt-8 text-center text-xs font-bold text-slate-400 uppercase tracking-tighter">
                Har du inget konto? <button className="text-[#003f5a] hover:underline ml-1 font-bold bg-transparent border-none p-0 cursor-pointer">Registrera dig här</button>
            </p>
        </div>
    );
};
